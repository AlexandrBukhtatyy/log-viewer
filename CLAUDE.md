...
Человеческая выжимка этих правил для контрибьюторов — [docs/conventions/task-management.md](docs/conventions/task-management.md) (этот раздел остаётся операционным источником истины).
