...
export const LvStatusBar = ({
  ...
  return (
    <div className="lv-status">
      ...
      <span className="lv-status-sep" />
      <span
        className="lv-status-item lv-level-error"
        style={{ color: 'var(--lv-level-error)' }}
      >
        {stats.errors} errors
      </span>
      <span
        className="lv-status-item lv-level-warn"
        style={{ color: 'var(--lv-level-warn)' }}
      >
